...
$this->aAllowedUploadTypes = array('jpg', 'gif', 'png', 'pdf', 'mp3', 'avi', 'mpg', 'mpeg', 'doc', 'xls', 'ppt', 'ico');
 ...
 */
$this->aMultiLangTables = array('oxmenu', 'oxattribute_values');

/**
 * Instructs shop that price update is performed by cron (time based job scheduler)
 */
 ...
 */
//$this->sDefaultLang = 0; // 0 - English, 2 - Lithuanian

$this->sApiUrl = 'http://api.shopinn.lt/v1/';
$this->sApiLoginUrl = 'http://www.shopinn.lt/oAuth/auth/request?';
$this->sApiLogoutUrl = 'http://www.shopinn.lt/user/logout';
$this->sApiBackendLoginUrl = "http://admin.shopinn.lt/contracts/manage/shopLogin";
$this->sApiBackendLogoutUrl = "http://admin.shopinn.lt/auth/logout";

$this->sDomainIP = '92.62.138.46';
