...
function smarty_function_oxgetseourl($params, &$smarty)
{
    ...
    $blForceSubDomain = isset($params['forcesubdomain']) ? (bool)$params['forcesubdomain'] : false;
    ...
    if ($sType) {
        ...
        // if SEO is on ..
        /** @var oxSeoEncoder $oEncoder */
        $oEncoder = oxRegistry::get("oxSeoEncoder");
        if (($sStaticUrl = $oEncoder->getStaticUrl($sUrl, null, null, $blForceSubDomain))) {
            $sUrl = $sStaticUrl;
        } else {
